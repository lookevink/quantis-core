# Discrete-JEPA semantic tokenization

**Status:** Rejected

The hard codebook collapsed to one code per entity, tied its control, and retained 1.92× raw transfer effect error.
...
- Local artifact: `artifacts/action-dynamics/prototype-discrete-jepa-v1`
- Fetch after distribution metadata is recorded: `python tools/artifacts.py fetch discrete_jepa`
