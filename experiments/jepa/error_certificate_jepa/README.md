...
The raw-preserving certificate passed safety gates but missed held-topology simultaneous coverage, detected no treatments, and was not sharper than controls.
...
- [Quantis JEPA-assisted certificate formulation and controls](../../../docs/specs/error-certificate-jepa-tracer-v1.md)
