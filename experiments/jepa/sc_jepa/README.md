# SC-JEPA codebook × multi-resolution interaction

**Status:** Rejected

The complete interaction had negligible Brier value, zero detection interaction, and collapsed per-entity code use.
...
- [SC-JEPA](https://arxiv.org/abs/2602.04643)

## Artifact

- Local artifact: `artifacts/action-dynamics/prototype-sc-jepa-interaction-v1`
- Fetch after distribution metadata is recorded: `python tools/artifacts.py fetch sc_jepa`
