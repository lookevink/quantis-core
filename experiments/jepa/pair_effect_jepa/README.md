...
Matched-twin training was slightly worse than its deranged null and the composed path regressed raw transfer effect.
...
- [Quantis matched-twin effect formulation and related work](../../../docs/specs/pair-effect-jepa-tracer-v1.md)
