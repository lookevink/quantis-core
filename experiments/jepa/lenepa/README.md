# Exact LeNEPA disposable projection

**Status:** Rejected

All protocol checks passed, but projection failed its mechanism gate and every learned cell failed raw forecast safety.
...
- [LeNEPA](https://arxiv.org/abs/2607.00958)

## Artifact

- Local artifact: `artifacts/action-dynamics/prototype-lenepa-jepa-v1`
- Fetch after distribution metadata is recorded: `python tools/artifacts.py fetch lenepa`
