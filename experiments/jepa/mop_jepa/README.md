# MoP-JEPA hard-assigned predictors

**Status:** Rejected

Hard assignment activated, but the alternatives lost to supervised hard-WTA, a static codebook, and raw dynamics.
...
- [MoP-JEPA](https://arxiv.org/abs/2607.05238)

## Artifact

- Local artifact: `artifacts/action-dynamics/prototype-mop-jepa-v1`
- Fetch after distribution metadata is recorded: `python tools/artifacts.py fetch mop_jepa`
