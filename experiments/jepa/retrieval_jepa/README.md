...
The query map was causal and edge-feasible, but raw telemetry and PCA retrieved every transfer mechanism while JEPA reached 40% hit@1.
...
- [Retrieval-JEPA primary-source notes and adaptation boundary](../../../docs/research/retrieval-jepa-primary-source-notes.md)
