# PEIRA inter-view regressor alignment

**Status:** Rejected

Aligned PEIRA learned a real non-collapsed mechanism but lost to derangement and reconstruction controls and retained 1.91× raw effect error.
...
- [PEIRA](https://arxiv.org/abs/2605.17671)

## Artifact

- Local artifact: `artifacts/action-dynamics/prototype-peira-v1`
- Fetch after distribution metadata is recorded: `python tools/artifacts.py fetch peira`
