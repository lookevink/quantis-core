# Quantis demand-conditioned v2 development regression
...
- Routine-noise response alerts: 0/21
- Pre-noise regression alerts: 0/108
...
- Pre-noise score median / threshold: 0.383 / 2.951
...
- Pre-noise score median / threshold: 0.516 / 2.951
- Raw-effect gates passed: True
...
- Detection delay: 0 logical windows
- Attribution top three: queue_depth, db_write_completion_ratio, worker_completion_ratio
- Pre-noise score median / threshold: 0.562 / 2.951
- Raw-effect gates passed: True
...
- Evaluated cases overlap training cases, realized request schedules, or fault timings; this is development regression evidence.
